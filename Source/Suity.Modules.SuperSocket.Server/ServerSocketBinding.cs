...
{
    public class ServerSocketBinding : NetworkServer, IModuleBinding, IVisionTreeObject, IInfoNode
    {
        ...
        public ServerSocketBinding(ModuleConfig config)
        {
            ...
            _server = new SsAppServer(packetFormat, compressed);
